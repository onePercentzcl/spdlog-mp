...
// Short MM/DD/YY date, 等价于 %m/%d/%y 08/23/01
template <typename ScopedPadder>
...
// ISO 8601 time format (HH:MM:SS), 等价于 %H:%M:%S
template <typename ScopedPadder>
...
// 示例: [logger-name] [info] [mdc_key_1:mdc_value_1 mdc_key_2:mdc_value_2] some message
#ifndef SPDLOG_NO_TLS
template <typename ScopedPadder>
